...
from OffLine.itemCF import itemCF
...
#    test.user_sim()
    ...
    for item_id, ctr in temp:
        middle = workflow.sqlSearch_room(item_id)
...
# 设置路由，即路由地址为http://106.12.83.14:2222/Rec-communityRoom
api.add_resource(TodoList, "/Rec-communityRoom")
